...
# Load the YOLOv5 model using torch.hub with force_reload=True to avoid cache issues
model = torch.hub.load("ultralytics/yolov5", "custom", path="C:/Users/deruf/Vision-KRTI-VTOL-2024/yolov5/best2.pt")
